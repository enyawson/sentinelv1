...
export const VIDEO_UPLOAD = MAIN_URL + 'incident/videoupload/';
export const IMAGE_UPLOAD = MAIN_URL + 'incident/imageupload/';
export const AUDIO_UPLOAD = MAIN_URL + 'incident/audioupload/';
